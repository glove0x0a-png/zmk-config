...
| # | XIAO(D) | XIAO(gpio) | コメント                                 |
| - |---------|------------|------------------------------------------|
| # | D18     | gpio1 5    | 0行 (0,5)～(0,11) &11列(0,11)～(3,11) |
| # | D9      | gpio1 14   | 1行 (1,5)～(1,11) &10列(0,10)～(3,10) |
| # | D19     | gpio1 7    | 2行 (2,5)～(2,11) & 9列(0, 9)～(3, 9) |
| # | D10     | gpio1 15   | 3行 (3,5)～(3,11) & 8列(0 ,8)～(3 ,8) |
| # | D14     | gpio0 9    | 拡張 (4,5)～(4,10) & 7列(0,7)～(3 ,7) |
| # | D3      | gpio0 29   | 5列 (0,5)～(3,5) & 拡張(4,5) |
| # | D13     | gpio1 1    | 6列 (0,6)～(3,6) & 拡張(4,6) |
| # | D2      | gpio0 28   | 7列 (0,7)～(3,7) & 拡張(4,7) |
| # | D12     | gpio0 19   | 8列 (0,8)～(3,8) & 拡張(4,8) |
| # | D1      | gpio0 3    | 9列 (0,9)～(3,9) & 拡張(4,9) |
| # | D11     | gpio0 15   | 10列 P & 2行(Caps ～F)             |
| # | D0      | gpio0 2    | 11列 - & 1行(Tab ～R)              |
| # | D4      | gpio0 4    | 未使用 |
| # | D5      | gpio0 5    | 未使用 |
| # | D6      | gpio1 11   | 未使用 |
| # | D7      | gpio1 12   | 未使用 |
| # | D8      | gpio1 13   | ws2812 アンダーグローLED制御            |
| # | D17     | gpio1 3    | 割り込みピンとして追加                  |
