...
## キーボード
  ...
  - Jキーを外してtrack ball(az1uball) 配置。(押込みでJキー)
...
| # | Pos | XIAO(D) | XIAO(gpio) | Matrix1 | Matrix2 | Matrix3 |
| - | --- |---------|------------|---------|---------|---------|
| 0   | LEFT  | D0      | gpio0 2    | 1行("Tab"～"R")    | 7列("-"～"Right")| 未使用 |
| 1-0 | LEFT  | D11     | gpio0 15   | 破損->D6へ         | 未使用           | 未使用
| 1-1 | LEFT  | D1      | gpio0 3    | 3行("Shift"～"V")  | 5列("O"～"Left") | 5列:"クリック" |
| 2-0 | LEFT  | D12     | gpio0 19   | 4行("Ctrl"～"Fn1") | 4列("I"～"UP")   | 4列:"↑" |
| 2-1 | LEFT  | D2      | gpio0 28   | なし               | 3列("U"～"Fn2")  | 3列:"←" |
| 3-0 | LEFT  | D13     | gpio1 1    | なし               | 2列("Y"～"N")    | 2列:"→" |
| 3-1 | LEFT  | D3      | gpio0 29   | なし               | 1列("T"～"△")   | 1列:"↓" |
| 4-0 | LEFT  | D14     | gpio0 9    | 未使用             | 未使用           | 未使用 |
...
| 8-1 | RIGHT | D8      | gpio1 13   | 2列("Q"～"Win")    |  2行("G"～":")      | - |
| 8-2 | RIGHT | D18     | gpio1 5    | 3列("W"～"ALT")    |  3行("B"～"Enter")  | - |
| 9-1 | RIGHT | D9      | gpio1 14   | 4列("E"～"L-CLK")  |  4行("△"～"Right") | - |
| 9-2 | RIGHT | D19     | gpio1 7    | 破損               | 未使用           | 未使用
| 10  | RIGHT | D10     | gpio1 15   | 5列("R"～"Fn1")    | 未使用           | 5行目 |
