...
| 1-0 | LEFT  | D11     | gpio0 15   | 破損->D6へ         | 未使用           |
| 1-1 | LEFT  | D1      | gpio0 3    | 3行("Shift"～"V")  | 5列("O"～"Left") |
| 2-0 | LEFT  | D12     | gpio0 19   | 4行("Ctrl"～"Fn1") | 4列("I"～"UP")   |
| 2-1 | LEFT  | D2      | gpio0 28   | なし               | 3列("U"～"Fn2")  |
| 3-0 | LEFT  | D13     | gpio1 1    | なし               | 2列("Y"～"N")    |
| 3-1 | LEFT  | D3      | gpio0 29   | なし               | 1列("T"～"△")   |
| 4-0 | LEFT  | D14     | gpio0 9    | 未使用             | 未使用           |
| 4-1 | LEFT  | D4      | gpio0 4    | I2C-SDA            | -                |
| 5-0 | LEFT  | D15     | gpio0 10   | 未使用             | 未使用           |
| 5-1 | LEFT  | D5      | gpio0 5    | I2C-SCL            | -                |
| 6-0 | LEFT  | D16     | gpio0 31   | 未使用             | 未使用           |
| 6-1 | LEFT  | D6      | gpio1 11   | 2行("Caps"～"F")   | 6列("P"～"Down") |
...
| 9-2 | RIGHT | D19     | gpio1 7    | 破損               | 未使用           |
| 10  | RIGHT | D10     | gpio1 15   | 5列("R"～"Fn1")    | 未使用           |
