...
| 1-1 | LEFT  | D1      | gpio0 3    | 3行("Shift"～"V")  |  5列("O"～"Left" & 拡張5行目"○") |
| 2-0 | LEFT  | D12     | gpio0 19   | 4行("Ctrl"～"Fn1") |  4列("I"～"UP"   & 拡張5行目"↑") |
| 2-1 | LEFT  | D2      | gpio0 28   | なし               |  3列("U"～"Fn2") & 拡張5行目"←") |
| 3-0 | LEFT  | D13     | gpio1 1    | なし               |  2列("Y"～"N")   & 拡張5行目"→") |
| 3-1 | LEFT  | D3      | gpio0 29   | なし               |  1列("T"～"△")  & 拡張5行目"↓") |
| 4-0 | LEFT  | D14     | gpio0 9    | 5列("R"～"Fn1")    |  拡張5行目(十字キー + ボタン) |
| 4-1 | LEFT  | D4      | gpio0 4    | 未使用 |
